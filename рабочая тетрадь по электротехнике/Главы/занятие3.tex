...
\begin{minipage}[h]{0.5\linewidth}
\center{\begin{circuitikz}[european] \draw
(0,0) to[battery, l=$\mathscr{E}$, invert] (0,2) to[R, l=$100~\text{Ом}$] (2,2) to[empty led, l=$\text{Кр}$,fill=red] (3.3,2) to[empty led, l=$\text{Жел}$,fill=yellow] (4.6,2)to[empty led, l=$\text{Зел}$,fill=green] (6,2) --
