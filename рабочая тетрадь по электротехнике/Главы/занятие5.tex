...
\hline
Схема        & \begin{tabular}[c]{@{}c@{}}ЭДС батареи\\ $\mathscr{E}$, В\end{tabular} & \begin{tabular}[c]{@{}c@{}}Сила тока \\ в цепи\\ $I$, мА\end{tabular} & \begin{tabular}[c]{@{}c@{}}Напряжение\\ $U_\text{жел}$, В\end{tabular} & \begin{tabular}[c]{@{}c@{}}Сопротивление \\светодиода $R_\text{св}$, Ом\end{tabular} & \begin{tabular}[c]{@{}c@{}}Горит светодиод?\\ да/нет\end{tabular} \\ \hline
К2 разомкнут &                                                                        &                                                                       &                                                                        &                                                                                      &                                                                   \\ \hline
К2 замкнут   &                                                                        &                                                                       &                                                                        &                                                                                      &                                                                   \\ \hline
\end{tabular}
\end{table}
